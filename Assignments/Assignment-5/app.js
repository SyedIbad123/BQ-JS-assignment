...
var fahrenTemperature2 = 86;
var celsiusTemperature2 = (fahrenheitTemperature - 32) * 5 / 9;
//Output on web page
document.write(fahrenheitTemperature + "°F is " + celsiusTemperature2 + "°C");
...
document.write("You will need " + lifetimeSupply + " " + favSnack + " to last you until the ripe old age of " + maxAge + ".");
